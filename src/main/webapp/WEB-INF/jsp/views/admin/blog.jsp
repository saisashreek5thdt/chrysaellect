								 ...
								 <div class="form-group row mb-4">
									 ...
									 <div class="col-sm-12 col-md-7">
										 <div id="image-preview" class="image-preview">
                                          ...
                                          <input type="file"  name="coverImage" required id="image-upload" />
                                         </div>
									 </div>
								 </div>
							 <div class="form-group row mb-4">
                        									 ...
                        									 <div class="col-sm-12 col-md-7">
                        										 <div id="image-preview" class="image-preview">
                                                                  <label for="image-upload" id="image-label">Choose File</label>
                                                                  <input type="file"  name="Image1" required id="image-upload" />
                                                                 </div>
                        									 </div>
                        								 </div>
								 	 ...
								 	 <div class="form-group row mb-4">
                                 									 ...
                                 									 <div class="col-sm-12 col-md-7">
                                 										 <div id="image-preview" class="image-preview">
                                                                           <label for="image-upload" id="image-label">Choose File</label>
                                                                           <input type="file"  name="Image2" required id="image-upload" />
                                                                          </div>
                                 									 </div>
                                 								 </div>
                                 <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                       <textarea class="summernote-simple" id="input2" required onChange="about()" ></textarea>
                                    </div>
                                 </div>
						 	 ...
						 	 <div class="form-group row mb-4">
                                                         									 ...
                                                         									 <div class="col-sm-12 col-md-7">
                                                         										 <div id="image-preview" class="image-preview">
                                                                                                   <label for="image-upload" id="image-label">Choose File</label>
                                                                                                   <input type="file"  name="authorImage" required id="image-upload" />
                                                                                                  </div>
                                                         									 </div>
                                                         								 </div>
