...
<br>
 ...
 <c:if test="${count>0}">
      ...
      <div class="col" id="outdiv"  >
        <div class="col" id="outdivcontent" style="width:70%;text-align:left"  >

             <c:forEach items="${blogList}" var="rowt">
                    <c:if test="${rowt.publish=='1'}">
                        	<c:set var="countz" value="${countz + 1}" scope="page"/>
                        			  <c:if test="${countz==1}">
...
<br>
          <font color="white" style="font-size:12px" > ${fn:substring(rowt.about1, 0, 130)}</font>
</small>
