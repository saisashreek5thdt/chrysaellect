    ...
    <div class="row">
        ...
        <div class="col-md-2" id="add">
            ...
            <div class="col-md-12" id="addsub">
                <div class="col" id="cir2" style="height:170px;border: 0px;">
               ...
               </div><div class="col" style="width: 100%;border-radius: 10px;  outline: 1px dashed #0A62A3;
  ...
  <c:set var="cou" value="${cou + 1}" scope="page"/>
   <c:if test="${cou<'6'}">
				<div class="col-md-2" >
					<div class="row justify-content-md-center">
						<div class="col-md-10" id="coursebody2" style="height:230px;background:#fff">
								...
								<div class="col" id="cir" style="height: 40%;">
		...
		<br>
												...
												${fn:substring(rok.about_course, 0, 290)}
